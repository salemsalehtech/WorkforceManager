...
namespace WorkforceManager.Business.Services
{
    ...
    public class ProductionMemoryService
    {
        ...
        /// <summary>
        /// نقل الخطة لقايمة المنجزة. بيتنادى من
        /// <c>FlowSessionViewModel</c> بعد أول حفظ إنتاج حقيقي للرحلة اللي
        /// فُتحت من الخطة دي — مش بمجرد فتح شاشة التسجيل (قرار سابق اتراجع
        /// عنه): تجربة فعلية أثبتت إن المستخدم بيفتح الشاشة من التذكير
        /// وميسجّلش حاجة، وتفضل الخطة معلّمة "منجزة" غلط من غير أي إنتاج
        /// حقيقي. دلوقتي التذكير بيوصّل المستخدم للشاشة بس، والخطة تتعلّم
        /// منجزة لما يحصل حفظ فعلي — لو محصلش، هتفضل نشطة وتتذكّره تاني.
        /// </summary>
