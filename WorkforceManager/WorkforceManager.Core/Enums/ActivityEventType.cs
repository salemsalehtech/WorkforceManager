namespace WorkforceManager.Core.Enums
{
    ...
    public enum ActivityEventType
    {
        ...
        /// <summary>
        /// يوم حساب إداري (مدير/رئيس قسم) اتصحّح يدويًا من بروفايل الحساب
        /// — حضور/سهر أو غياب. لازم كاتب زي أي تعديل حضور تاني: التصحيح
        /// ده بيغيّر يومية مدفوعة، وكان بيحصل من غير أثر خالص في السجل
