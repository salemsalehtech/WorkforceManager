...
namespace WorkforceManager.Core.Models
{
    ...
    public class Penalty
    {
        ...
        /// </summary>
        [Required]
        public PenaltySource Source { get; set; } = PenaltySource.Manual;

        /// <summary>هل ده جزاء ولّده النظام؟ (يعني مسموح للنظام يشيله لوحده)</summary>
        [NotMapped]
        public bool IsAutoGenerated => Source != PenaltySource.Manual;
