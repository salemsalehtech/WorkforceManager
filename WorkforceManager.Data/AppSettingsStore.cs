...
namespace WorkforceManager.Data
{
    ...
    public class AppSettings
    {
        ...
        ///
        /// منفصل عن <see cref="AppLogoPath"/> عن قصد: شعار التقرير
        /// عادةً هيدر كامل (ورقة مطبوعة)، وشعار البرنامج لازم يتظبط
        /// جوّه مربع صغير (بادچ) — نفس الصورة نادرًا ما تناسب الاتنين.
        /// </summary>
        public string? LogoPath { get; set; }

        /// <summary>
        /// مسار صورة شعار البرنامج نفسه — بيحل محل شعار WMS الافتراضي
        /// في القايمة الجانبية وشاشة تسجيل الدخول وكارت العمال الفاضي
        /// وأيقونة النافذة/الـ Taskbar. مش نفس <see cref="LogoPath"/>
        /// (شعار التقارير) عن قصد، شوف التوثيق هناك.
        /// </summary>
