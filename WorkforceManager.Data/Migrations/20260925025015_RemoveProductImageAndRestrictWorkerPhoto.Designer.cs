...
namespace WorkforceManager.Data.Migrations
{
    ...
    [Migration("20260925025015_RemoveProductImageAndRestrictWorkerPhoto")]
    partial class RemoveProductImageAndRestrictWorkerPhoto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkforceManager.Core.Models.MonthlyPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int?>("DailyTargetQuantity")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("MonthlyPlans", t =>
                        {
                            t.HasCheckConstraint("CK_MonthlyPlan_DailyTargetQuantity_NonNegative", "DailyTargetQuantity IS NULL OR DailyTargetQuantity >= 0");

                            t.HasCheckConstraint("CK_MonthlyPlan_Month_Valid", "Month BETWEEN 1 AND 12");

                            t.HasCheckConstraint("CK_MonthlyPlan_PlannedQuantity_NonNegative", "PlannedQuantity >= 0");
                        });
                });

            modelBuilder.Entity("WorkforceManager.Core.Models.MonthlyPlanCorrection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("WorkforceManager.Core.Models.MonthlyWorkCalendarHoliday", b =>
                {
                    ...
                    b.ToTable("MonthlyWorkCalendarHolidays");
                });
            ...
            modelBuilder.Entity("WorkforceManager.Core.Models.Product", b =>
                {
                    ...
                    b.ToTable("Products", t =>
                        {
                            t.HasCheckConstraint("CK_Product_PieceWeightGrams_Positive", "PieceWeightGrams IS NULL OR PieceWeightGrams > 0");
                        });
                });

            modelBuilder.Entity("WorkforceManager.Core.Models.ProductFamily", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("WorkforceManager.Core.Models.ProductionMemoryStage", b =>
                {
                    ...
                    b.Property<int>("ProductionMemoryId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("WorkforceManager.Core.Models.Product", b =>
                {
                    b.HasOne("WorkforceManager.Core.Models.ProductFamily", "Family")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("WorkforceManager.Core.Models.ProductionMemoryStage", b =>
                {
                    b.HasOne("WorkforceManager.Core.Models.ProductionMemory", "ProductionMemory")
                        .WithMany("Stages")
                        .HasForeignKey("ProductionMemoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
